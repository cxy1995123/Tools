...
package chen.com.library.google.camera;
...
//            mPreviewSizes.add(new Size(width, height));
    ...
    private void setupImageReader() {
        ...
        Size largest = mPictureSizes.sizes(mAspectRatio).last();
        previewImageReader = ImageReader.newInstance(largest.getWidth(), largest.getHeight(), ImageFormat.YUV_420_888, 1);
        previewImageReader.setOnImageAvailableListener(new ImageReader.OnImageAvailableListener() {
            @Override
            public void onImageAvailable(ImageReader reader) {
                Log.i("Camera2", "previewImageReader: ");
    ...
    void startCaptureSession() {
        ...
        try {
            ...
            mCamera.createCaptureSession(Arrays.asList(surface, previewImageReader.getSurface(), mImageReader.getSurface()),
