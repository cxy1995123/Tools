...
import chen.com.library.activity.BaseActivity
import chen.com.library.activity.TestFragmentActivity
...
class FragmentSupporterActivity : BaseActivity() {
    ...
    companion object{
        ...
        @JvmStatic
        fun launcher(activity: Activity?, fragmentClass: Class<*>, bundle: Bundle?= null,
                     @StyleRes res: Int =-1, requestCode:Int = REQUEST_CODE) {
            val intent = Intent()
            if (bundle != null) {
                intent.putExtras(bundle)
